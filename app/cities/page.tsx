...
const CITIES = [
  { name: "Atlanta, GA", routes: 12, newRoutes: 3, totalBids: 45 },
  { name: "Austin, TX", routes: 8, newRoutes: 0, totalBids: 18 },
  { name: "Boston, MA", routes: 15, newRoutes: 5, totalBids: 32 },
  { name: "Buffalo, NY", routes: 6, newRoutes: 1, totalBids: 12 },
  { name: "Chicago, IL", routes: 20, newRoutes: 2, totalBids: 56 },
  { name: "Cleveland, OH", routes: 9, newRoutes: 0, totalBids: 21 },
  { name: "Dallas, TX", routes: 18, newRoutes: 4, totalBids: 48 },
  { name: "Denver, CO", routes: 11, newRoutes: 1, totalBids: 28 },
  { name: "El Paso, TX", routes: 7, newRoutes: 0, totalBids: 15 },
  { name: "Fresno, CA", routes: 5, newRoutes: 0, totalBids: 9 },
  { name: "Houston, TX", routes: 16, newRoutes: 3, totalBids: 41 },
  { name: "Indianapolis, IN", routes: 10, newRoutes: 2, totalBids: 24 },
  { name: "Jacksonville, FL", routes: 8, newRoutes: 1, totalBids: 19 },
  { name: "Kansas City, MO", routes: 9, newRoutes: 0, totalBids: 22 },
  { name: "Las Vegas, NV", routes: 12, newRoutes: 2, totalBids: 31 },
  { name: "Los Angeles, CA", routes: 25, newRoutes: 6, totalBids: 67 },
  { name: "Miami, FL", routes: 14, newRoutes: 3, totalBids: 38 },
  { name: "Milwaukee, WI", routes: 7, newRoutes: 0, totalBids: 16 },
  { name: "Nashville, TN", routes: 11, newRoutes: 1, totalBids: 27 },
  { name: "New Orleans, LA", routes: 9, newRoutes: 2, totalBids: 23 },
  { name: "New York, NY", routes: 22, newRoutes: 5, totalBids: 59 },
  { name: "Oklahoma City, OK", routes: 8, newRoutes: 0, totalBids: 17 },
  { name: "Orlando, FL", routes: 10, newRoutes: 1, totalBids: 25 },
  { name: "Philadelphia, PA", routes: 17, newRoutes: 4, totalBids: 44 },
  { name: "Phoenix, AZ", routes: 13, newRoutes: 2, totalBids: 34 },
  { name: "Portland, OR", routes: 10, newRoutes: 1, totalBids: 26 },
  { name: "Raleigh, NC", routes: 8, newRoutes: 0, totalBids: 18 },
  { name: "Sacramento, CA", routes: 9, newRoutes: 1, totalBids: 21 },
  { name: "San Antonio, TX", routes: 12, newRoutes: 2, totalBids: 30 },
  { name: "San Diego, CA", routes: 14, newRoutes: 3, totalBids: 36 },
  { name: "San Francisco, CA", routes: 16, newRoutes: 4, totalBids: 42 },
  { name: "Seattle, WA", routes: 15, newRoutes: 3, totalBids: 39 },
  { name: "St. Louis, MO", routes: 11, newRoutes: 1, totalBids: 28 },
  { name: "Tampa, FL", routes: 10, newRoutes: 2, totalBids: 26 },
  { name: "Tucson, AZ", routes: 6, newRoutes: 0, totalBids: 13 },
  { name: "Virginia Beach, VA", routes: 7, newRoutes: 1, totalBids: 16 },
  { name: "Washington, DC", routes: 19, newRoutes: 4, totalBids: 51 },
]
